...
<%
	System.out.println("adminBoardList.jsp입니다.");
%>
		<title>관리자 - 게시글 목록 adminBoardList.jspt</title>
		<style type="text/css">
				.navbar-nav {
			    float: left;
			    width: auto;
		...
		<script type="text/javascript">
			$(function(){
				...
				$(".b_title").click(function(){
					...
					location.href="/admin/board/adminBoardDetail?b_num="+$(this).parent("tr").data('num');
				});
