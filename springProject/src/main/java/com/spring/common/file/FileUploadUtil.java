...
public class FileUploadUtil {
	 ...
	 * 파일 업로드할 폴더 생성
	 * static 메서드
	 *  C://10.webDeveloper//uploadStorage 안에 xx라는 폴더가 존재하니?
	 *
	 ********************************************************************************/
	...
	public static String fileUpload(MultipartFile file,String fileName) throws IOException {  //fileName은 board라고 가정하자,
		...
		if(org_name != null && (!org_name.equals(""))) {
			...
			String docRoot = "C://10.webDeveloper//uploadStorage//"+fileName; //C://10.webDeveloper//uploadStorage//board
	...
	public static void fileDelete(String fileName) throws IOException{
		...
		if(dirName.equals("thumbnail")) {
			...
			docRoot = "C://10.webDeveloper//uploadStorage//"+startDirName+"//"+dirName;
			
			log.info("startDirName : "+startDirName);
			log.info("docRoot : "+docRoot);
		}else {
			docRoot = "C://10.webDeveloper//uploadStorage//"+dirName;
			log.info("docRoot : "+docRoot);
		}
